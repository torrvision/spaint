...
IF(WITH_CUDA)
  ...
  IF(MSVC_IDE)
    ...
    SET(CUDA_NVCC_FLAGS -Xcudafe "--diag_suppress=bad_friend_decl" ; -Xcudafe "--diag_suppress=base_class_has_different_dll_interface" ; -Xcudafe "--diag_suppress=overloaded_function_linkage" ; -Xcudafe "--diag_suppress=useless_type_qualifier_on_return_type" ; ${CUDA_NVCC_FLAGS})
  ELSE()
