...
ELSE()
  FIND_PATH(SDL_INCLUDE_DIR SDL.h HINTS "${PROJECT_SOURCE_DIR}/libraries/SDL2-2.0.7/include")
  FIND_LIBRARY(SDL_LIBRARY SDL2-2.0 HINTS "${PROJECT_SOURCE_DIR}/libraries/SDL2-2.0.7/build")
  FIND_LIBRARY(SDLMAIN_LIBRARY SDL2main HINTS "${PROJECT_SOURCE_DIR}/libraries/SDL2-2.0.7/build")
ENDIF()
