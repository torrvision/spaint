...
function GenerateSpaintTags()
  !ctags -R --sort=yes --langmap=C++:+.cu --c++-kinds=+p --fields=+iaS --extra=+qf --exclude=libraries -f ./spaint.tags .
endfunction
command GenerateSpaintTags execute GenerateSpaintTags()

function GenerateLibraryTags()
  !ctags -R --sort=yes --langmap=C++:+.cu --c++-kinds=+p --fields=+iaS --extra=+qf -L libraries/ -f ./library.tags .
endfunction
command GenerateLibraryTags execute GenerateLibraryTags()

function GenerateInfiniTAMTags()
  !ctags -R --sort=yes --langmap=C++:+.cu --c++-kinds=+p --fields=+iaS --extra=+qf --exclude=build --exclude=.git --exclude=cmake -f ./infinitam.tags ../InfiniTAM/InfiniTAM/
endfunction
