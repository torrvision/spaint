...
RiftRenderer::RiftRenderer(const std::string& title, const Model_CPtr& model, const Raycaster_CPtr& raycaster, const SubwindowConfiguration_Ptr& subwindowConfiguration,
                           RiftRenderingMode renderingMode)
: Renderer(model, raycaster, subwindowConfiguration)
{
