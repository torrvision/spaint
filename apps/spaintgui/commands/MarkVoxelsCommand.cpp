...
{
  m_model->mark_voxels(m_voxelLocationsMB, m_label, m_model->get_scene("World"), NORMAL_MARKING, m_oldVoxelLabelsMB);
}

void MarkVoxelsCommand::undo() const
{
  m_model->mark_voxels(m_voxelLocationsMB, m_oldVoxelLabelsMB, m_model->get_scene("World"), FORCED_MARKING);
}
