...
/**
 * \brief An instance of this class can be used to sample voxels from a scene using CUDA.
 */
...
public:
   ...
   */
  VoxelSampler_CUDA(const LabelManager_CPtr& labelManager, int maxVoxelsPerLabel, int raycastResultSize, unsigned int seed);
