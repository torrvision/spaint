...
private:
   ...
   */
  virtual void calculate_normals(const ITMFloat4Image *raycastResult, const Scene *scene) const = 0;
   ...
   * \param scene         The scene.
   */
  virtual void perform_propagation(SpaintVoxel::Label label, const ITMFloat4Image *raycastResult, Scene *scene) const = 0;
...
public:
   ...
   * \param scene         The scene.
   */
  void propagate_label(SpaintVoxel::Label label, const ITMFloat4Image *raycastResult, Scene *scene) const;
};
