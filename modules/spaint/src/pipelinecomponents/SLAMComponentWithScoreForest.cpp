        ...
        trackerParams, mappingMode, trackingMode)
{
  ...
  m_relocalisationForestPath = globalParams.get_first_value<std::string>(parametersNamespace + "m_relocalisationForestPath", defaultRelocalisationForestPath);
...
//  m_scoreRelocaliser = RelocaliserFactory::make_score_relocaliser(ITMLibSettings::DEVICE_CPU, m_relocalisationForestPath);
  ...
  m_refinementTrackerParams =
      globalParams.get_first_value<std::string>(
  ...
  m_relocaliseAfterEveryFrame = globalParams.get_first_value<bool>(
      parametersNamespace + "m_relocaliseAfterEveryFrame", false);
  m_saveRelocalisationPoses = globalParams.get_first_value<bool>(
