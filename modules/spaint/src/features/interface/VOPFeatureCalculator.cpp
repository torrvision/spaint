...
void VOPFeatureCalculator::calculate_features(const ORUtils::MemoryBlock<Vector3s>& voxelLocationsMB, const Scene *scene, ORUtils::MemoryBlock<float>& featuresMB) const
{
