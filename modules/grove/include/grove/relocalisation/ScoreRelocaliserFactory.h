...
public:
   ...
   */
  static ScoreRelocaliser_Ptr make_score_relocaliser(DeviceType deviceType, const tvgutil::SettingsContainer_CPtr& settings, const std::string& forestFilename, const std::string& settingsNamespace = "ScoreRelocaliser.");
};
