...
ScoreRelocaliser_CPU::ScoreRelocaliser_CPU(const SettingsContainer_CPtr& settings, const std::string& settingsNamespace, const std::string& forestFilename)
: ScoreRelocaliser(settings, settingsNamespace, forestFilename, DEVICE_CPU)
{}
