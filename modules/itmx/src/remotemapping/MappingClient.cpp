...
MappingClient::MappingClient(const std::string& host, const std::string& port, pooled_queue::PoolEmptyStrategy pooledQueueStrategy)
: m_frameMessageQueue(pooledQueueStrategy), m_stream(host, port)
{
